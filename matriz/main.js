...
function init() {
  ...
  btn1.innerHTML = "crear matris y transponerla";
  btn1.id = "1";
  let btn2 = document.createElement("button");
  btn2.innerHTML = "crear 2 matrices y sumarlas ";
  btn2.id = "2";
  let btn3 = document.createElement("button");
  btn3.innerHTML = "crear 2 matrices y restarlas ";
  btn3.id = "3";
  let btn4 = document.createElement("button");
  btn4.innerHTML = "crear 1 matrices y multiplicarla por un escalar";
  btn4.id = "4";
  let btn5 = document.createElement("button");
  btn5.innerHTML = "crear 2 matrices y multiplicarlas";
  btn5.id = "5";
  var inp1 = document.createElement("input");
  inp1.placeholder = "filas";
  inp1.id = "fila";
  var inp2 = document.createElement("input");
  inp2.placeholder = "columnas";
  inp2.id = "columna";
  var inp3 = document.createElement("input");
  inp3.placeholder = "escalar";
  inp3.id = "escalar";
  ...
  let nombre3 = document.createElement("p");
  nombre3.innerHTML = "matriz 3";
...
function visual(x, m1) {
  ...
  for (let index = 0; index < m1.length; index++) {
    ...
    document.getElementById(x).innerHTML += `<div>${m1[index]}</div>`;
  }
}
